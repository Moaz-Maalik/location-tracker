            ...
            <div className="row">
              <div className="col-md-6">
                <div className="detail-box">
                  ...
                  <p>
                    AJ Solars connects clients with expert solar professionals.
                    Whether you need installation, cleaning, or maintenance, we
                    make it easy to find trusted services. For installers, it’s
                    a platform to reach new clients and grow your
                    business—powering a cleaner future together.
                  </p>
                  <button
                    className="btn btn-warning"
                    href="#professional_section"
                    onClick={handleRequestAccess}
                  >
                    I'm a Homeowner – Find a Solar Expert
                  </button>
                  <button
                    href="#professional_section"
                    ...
                    onClick={handleRequestAccess}
                  >
                    I'm a Solar Expert – Get More Jobs
                  </button>
                </div>
              </div>
              <div className="col-md-6">
