export function collectInformation() {
    ...
    else if (ver.includes('Chrome')) brw = ver.split(' Chrome/')[1]?.split(' ')[0];
    else if (ver.includes('Safari')) brw = ver.split(' Safari/')[1]?.split(' ')[0];
  ...
  export function locate(callback, errCallback) {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        console.log('moaz info location', {
            Status: 'success',
